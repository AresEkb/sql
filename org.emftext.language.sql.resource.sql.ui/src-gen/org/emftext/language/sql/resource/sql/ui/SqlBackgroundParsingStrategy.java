 ...
 */
public class SqlBackgroundParsingStrategy {
	 ...
	 */
	public void parse(DocumentEvent event, final org.emftext.language.sql.resource.sql.ISqlTextResource resource, final org.emftext.language.sql.resource.sql.ui.SqlEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(IDocument document, final org.emftext.language.sql.resource.sql.ISqlTextResource resource, final org.emftext.language.sql.resource.sql.ui.SqlEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.emftext.language.sql.resource.sql.ISqlTextResource resource, final org.emftext.language.sql.resource.sql.ui.SqlEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof org.emftext.language.sql.resource.sql.mopp.SqlResource) {
							org.emftext.language.sql.resource.sql.mopp.SqlResource concreteResource = (org.emftext.language.sql.resource.sql.mopp.SqlResource) resource;
