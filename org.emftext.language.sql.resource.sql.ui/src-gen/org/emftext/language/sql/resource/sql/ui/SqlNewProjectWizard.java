 ...
 * </p>
 */
public class SqlNewProjectWizard extends Wizard implements INewWizard, IExecutableExtension {
	
	/**
	 * The name of the ZIP file that is used as content for the new project (relative
	 * to the root of the resource UI plug-in).
	 */
	public final static String NEW_PROJECT_ZIP_FILE_NAME = org.emftext.language.sql.resource.sql.ui.SqlUIResourceBundle.NEW_PROJECT_ZIP_FILE_NAME;
	 ...
	 */
	protected String pageName = org.emftext.language.sql.resource.sql.ui.SqlUIResourceBundle.NEW_PROJECT_WIZARD_PAGE_NAME;
	 ...
	 */
	protected String pageDescription = org.emftext.language.sql.resource.sql.ui.SqlUIResourceBundle.NEW_PROJECT_WIZARD_PAGE_DESCRIPTION;
	
	/**
	 * The name of the project in the project creation page
	 */
	protected String pageProjectName = org.emftext.language.sql.resource.sql.ui.SqlUIResourceBundle.NEW_PROJECT_WIZARD_PROJECT_NAME;
	 ...
	 * org.emftext.language.sql.resource.sql.ui.SqlNewProjectWizardLogic.
	 */
	...
	protected void doPerformFinish(IProgressMonitor monitor) throws Exception {
		new org.emftext.language.sql.resource.sql.ui.SqlNewProjectWizardLogic().createExampleProject(monitor, wizardNewProjectCreationPage.getLocationPath(), wizardNewProjectCreationPage.getProjectName(), org.emftext.language.sql.resource.sql.ui.SqlUIPlugin.PLUGIN_ID, NEW_PROJECT_ZIP_FILE_NAME);
	}
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		...
		IPath path = new Path(org.emftext.language.sql.resource.sql.ui.SqlUIResourceBundle.NEW_PROJECT_WIZARD_PAGE_ICON);
		Bundle bundle = org.emftext.language.sql.resource.sql.ui.SqlUIPlugin.getDefault().getBundle();
		...
		setWindowTitle(org.emftext.language.sql.resource.sql.ui.SqlUIResourceBundle.NEW_PROJECT_WIZARD_WINDOW_TITLE);
	}
