 ...
 */
public class SqlHyperlink implements IHyperlink {
	 ...
	 */
	public SqlHyperlink(IRegion region, EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				org.emftext.language.sql.resource.sql.mopp.SqlPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
