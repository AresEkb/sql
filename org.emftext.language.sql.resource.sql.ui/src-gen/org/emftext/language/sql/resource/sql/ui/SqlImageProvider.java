...
public class SqlImageProvider {
	...
	public final static SqlImageProvider INSTANCE = new SqlImageProvider();
	...
	public ImageDescriptor getImageDescriptor(String key) {
		...
		if (ImageDescriptor.getMissingImageDescriptor().equals(descriptor) || descriptor == null) {
			...
			try {
				...
				org.emftext.language.sql.resource.sql.ui.SqlUIPlugin.logError("IconProvider can't load image (URL is malformed).", mue);
			}
		}
		return descriptor;
	}
