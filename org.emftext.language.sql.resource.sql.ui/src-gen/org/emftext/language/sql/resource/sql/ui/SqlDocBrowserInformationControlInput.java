 ...
 * olInput</code>.
 */
public class SqlDocBrowserInformationControlInput {
	
	private final SqlDocBrowserInformationControlInput fPrevious;
	private SqlDocBrowserInformationControlInput fNext;
	 ...
	 */
	public SqlDocBrowserInformationControlInput(SqlDocBrowserInformationControlInput previous, EObject element, Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public SqlDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public SqlDocBrowserInformationControlInput getNext() {
		return fNext;
	}
