 ...
 * @since 3.2
 */
public class SqlBrowserInformationControl extends AbstractInformationControl implements IInformationControlExtension2, IDelayedInputChangeProvider {
	...
	private org.emftext.language.sql.resource.sql.ui.SqlDocBrowserInformationControlInput fInput;
	 ...
	 */
	public SqlBrowserInformationControl(Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public SqlBrowserInformationControl(Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public SqlBrowserInformationControl(Shell parent, String symbolicFontName, ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		Assert.isLegal(input == null || input instanceof String || input instanceof org.emftext.language.sql.resource.sql.ui.SqlDocBrowserInformationControlInput);
		...
		fInput= (org.emftext.language.sql.resource.sql.ui.SqlDocBrowserInformationControlInput) input;
		...
		org.emftext.language.sql.resource.sql.ui.SqlHTMLPrinter.insertStyles(buffer, styles);
	...
	public Point computeSizeHint() {
		...
		String text;
		try {
			text = org.emftext.language.sql.resource.sql.ui.SqlHTMLPrinter.html2text(new StringReader(fInput.getHtml()), presentation);
		} catch (IOException e) {
			text = "";
		}
	 ...
	 */
	public org.emftext.language.sql.resource.sql.ui.SqlDocBrowserInformationControlInput getInput() {
		return fInput;
	}
