...
/**
 * The SqlAutoEditStrategy extends the default auto edit strategy such that an
 ...
 */
public class SqlAutoEditStrategy extends DefaultIndentLineAutoEditStrategy {
	
	private org.emftext.language.sql.resource.sql.ui.SqlBracketSet bracketSet;
	
	public SqlAutoEditStrategy() {
		super();
		...
		if (plugin != null) {
			...
			bracketSet = new org.emftext.language.sql.resource.sql.ui.SqlBracketSet();
	 ...
	 */
	@Deprecated
	public void setBracketSet(org.emftext.language.sql.resource.sql.ui.SqlBracketSet bracketSet) {
