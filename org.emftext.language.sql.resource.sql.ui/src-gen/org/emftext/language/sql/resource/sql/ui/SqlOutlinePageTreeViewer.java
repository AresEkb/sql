 ...
 * a specified depth.
 */
public class SqlOutlinePageTreeViewer extends TreeViewer {
	...
	public SqlOutlinePageTreeViewer(Composite parent, int style) {
		super(parent, style);
	...
	public void setSelection(ISelection selection, boolean reveal) {
		...
		if (selection instanceof org.emftext.language.sql.resource.sql.ui.SqlEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.emftext.language.sql.resource.sql.mopp.SqlPlugin.logError("Exception while refreshing outline view", e);
		}
	}
