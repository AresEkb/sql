...
public class SqlPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public void init(IWorkbench workbench) {
		...
		setDescription(org.emftext.language.sql.resource.sql.ui.SqlUIResourceBundle.ROOT_PREFERENCE_PAGE_DESCRIPTION);
	}
	...
	protected Control createContents(Composite parent) {
		...
		link.setText(org.emftext.language.sql.resource.sql.ui.SqlUIResourceBundle.ROOT_PREFERENCE_PAGE_TEXT);
		link.setSize(140, 40);
