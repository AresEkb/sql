 ...
 */
public class SqlOutlinePage extends Page implements ISelectionProvider, ISelectionChangedListener, IContentOutlinePage {
	
	public final static String CONTEXT_MENU_ID = "org.emftext.language.sql.resource.sql.ui.outlinecontext";
	...
	public SqlOutlinePage(org.emftext.language.sql.resource.sql.ISqlResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
	}
	
	public void createControl(Composite parent) {
		treeViewer = new org.emftext.language.sql.resource.sql.ui.SqlOutlinePageTreeViewer(parent, SWT.MULTI | SWT.H_SCROLL | SWT.V_SCROLL);
				...
				if (viewer != null && viewer.getControl() != null && !viewer.getControl().isDisposed()) {
					viewerRefresh = new ViewerRefresh(viewer) {
						...
						protected void refresh(IViewerNotification notification) {
							if (viewer instanceof org.emftext.language.sql.resource.sql.ui.SqlOutlinePageTreeViewer) {
								org.emftext.language.sql.resource.sql.ui.SqlOutlinePageTreeViewer pageTreeViewer = (org.emftext.language.sql.resource.sql.ui.SqlOutlinePageTreeViewer) viewer;
		...
		treeViewer.setComparator(new org.emftext.language.sql.resource.sql.ui.SqlOutlinePageTreeViewerComparator());
		createContextMenu();
		createActions();
	}
	...
	private void createContextMenu() {
		...
		getSite().registerContextMenu("org.emftext.language.sql.resource.sql.ui.outlinecontext", menuManager, treeViewer);
	}
	...
	private void createActions() {
		...
		List<IAction> actions = new org.emftext.language.sql.resource.sql.ui.SqlOutlinePageActionProvider().getActions(treeViewer);
