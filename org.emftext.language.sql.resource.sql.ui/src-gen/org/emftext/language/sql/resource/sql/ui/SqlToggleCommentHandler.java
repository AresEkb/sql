...
public class SqlToggleCommentHandler extends AbstractHandler {
	...
	public boolean isEnabled() {
		...
		if (activeEditor instanceof org.emftext.language.sql.resource.sql.ui.SqlEditor) {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		org.emftext.language.sql.resource.sql.ui.SqlEditor editor = null;
		
		if (editorPart instanceof org.emftext.language.sql.resource.sql.ui.SqlEditor) {
			editor = (org.emftext.language.sql.resource.sql.ui.SqlEditor) editorPart;
