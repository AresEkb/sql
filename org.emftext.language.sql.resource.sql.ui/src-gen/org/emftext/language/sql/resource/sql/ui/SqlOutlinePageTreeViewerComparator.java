...
public class SqlOutlinePageTreeViewerComparator extends ViewerComparator {
	...
	public int compare(Viewer viewer, Object o1, Object o2) {
		...
		if (sortLexically && o1 instanceof EObject && o2 instanceof EObject) {
			...
			org.emftext.language.sql.resource.sql.ISqlNameProvider nameProvider = new org.emftext.language.sql.resource.sql.mopp.SqlMetaInformation().createNameProvider();
