 ...
 */
public class SqlIgnoredWordsFilter {
	...
	public boolean ignoreWord(String word) {
		...
		return org.emftext.language.sql.resource.sql.grammar.SqlGrammarInformationProvider.INSTANCE.getKeywords().contains(word);
	}
