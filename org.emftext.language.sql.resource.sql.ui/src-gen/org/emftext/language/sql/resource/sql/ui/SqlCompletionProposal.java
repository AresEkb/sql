 ...
 */
public class SqlCompletionProposal implements Comparable<SqlCompletionProposal> {
	
	/**
	 * The terminal that was expected at the cursor position.
	 */
	private org.emftext.language.sql.resource.sql.mopp.SqlExpectedTerminal expectedTerminal;
	...
	public SqlCompletionProposal(org.emftext.language.sql.resource.sql.mopp.SqlExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container) {
		super();
	...
	public SqlCompletionProposal(org.emftext.language.sql.resource.sql.mopp.SqlExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public SqlCompletionProposal(org.emftext.language.sql.resource.sql.mopp.SqlExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image, String displayString) {
	...
	public org.emftext.language.sql.resource.sql.mopp.SqlExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof SqlCompletionProposal) {
			SqlCompletionProposal other = (SqlCompletionProposal) object;
	...
	public int compareTo(SqlCompletionProposal object) {
		if (object instanceof SqlCompletionProposal) {
			SqlCompletionProposal other = (SqlCompletionProposal) object;
