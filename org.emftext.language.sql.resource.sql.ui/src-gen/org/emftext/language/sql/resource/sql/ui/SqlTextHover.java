 ...
 */
public class SqlTextHover implements ITextHover, ITextHoverExtension, ITextHoverExtension2 {
	...
	private org.emftext.language.sql.resource.sql.ISqlHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends Action {
		...
		private final org.emftext.language.sql.resource.sql.ui.SqlBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.emftext.language.sql.resource.sql.ui.SqlBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.emftext.language.sql.resource.sql.ui.SqlDocBrowserInformationControlInput infoInput = (org.emftext.language.sql.resource.sql.ui.SqlDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.emftext.language.sql.resource.sql.ui.SqlHyperlink hyperlink = new org.emftext.language.sql.resource.sql.ui.SqlHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends AbstractReusableInformationControlCreator {
		...
		public IInformationControl doCreateInformationControl(Shell parent) {
			if (org.emftext.language.sql.resource.sql.ui.SqlBrowserInformationControl.isAvailable(parent)) {
				ToolBarManager tbm = new ToolBarManager(SWT.FLAT);
				org.emftext.language.sql.resource.sql.ui.SqlBrowserInformationControl iControl = new org.emftext.language.sql.resource.sql.ui.SqlBrowserInformationControl(parent, FONT, tbm);
				...
				IInputChangedListener inputChangeListener = new IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.emftext.language.sql.resource.sql.ui.SqlDocBrowserInformationControlInput) {
							org.emftext.language.sql.resource.sql.ui.SqlDocBrowserInformationControlInput input = (org.emftext.language.sql.resource.sql.ui.SqlDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends AbstractReusableInformationControlCreator {
		...
		public IInformationControl doCreateInformationControl(Shell parent) {
			...
			if (org.emftext.language.sql.resource.sql.ui.SqlBrowserInformationControl.isAvailable(parent)) {
				org.emftext.language.sql.resource.sql.ui.SqlBrowserInformationControl iControl = new org.emftext.language.sql.resource.sql.ui.SqlBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public SqlTextHover(org.emftext.language.sql.resource.sql.ISqlResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.emftext.language.sql.resource.sql.ui.SqlUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(ITextViewer textViewer, IRegion hoverRegion) {
		...
		return ((org.emftext.language.sql.resource.sql.ui.SqlDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private org.emftext.language.sql.resource.sql.ui.SqlDocBrowserInformationControlInput internalGetHoverInfo(ITextViewer textViewer, IRegion hoverRegion) {
	 ...
	 */
	private org.emftext.language.sql.resource.sql.ui.SqlDocBrowserInformationControlInput getHoverInfo(List<EObject> elements, ITextViewer textViewer, org.emftext.language.sql.resource.sql.ui.SqlDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.emftext.language.sql.resource.sql.ui.SqlHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.emftext.language.sql.resource.sql.ui.SqlHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.emftext.language.sql.resource.sql.ui.SqlHTMLPrinter.insertPageProlog(buffer, 0, org.emftext.language.sql.resource.sql.ui.SqlTextHover.getStyleSheet());
			org.emftext.language.sql.resource.sql.ui.SqlHTMLPrinter.addPageEpilog(buffer);
			return new org.emftext.language.sql.resource.sql.ui.SqlDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = org.emftext.language.sql.resource.sql.ui.SqlHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		Bundle bundle = Platform.getBundle(org.emftext.language.sql.resource.sql.ui.SqlUIPlugin.PLUGIN_ID);
		URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.emftext.language.sql.resource.sql.util.SqlStreamUtil.getContent(styleSheetURL.openStream());
