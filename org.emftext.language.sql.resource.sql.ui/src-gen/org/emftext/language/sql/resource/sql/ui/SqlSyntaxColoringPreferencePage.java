 ...
 * </p>
 */
public class SqlSyntaxColoringPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public SqlSyntaxColoringPreferencePage() {
		super();
		
		org.emftext.language.sql.resource.sql.mopp.SqlMetaInformation metaInformation = new org.emftext.language.sql.resource.sql.mopp.SqlMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.emftext.language.sql.resource.sql.ui.SqlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.sql.resource.sql.ui.SqlSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.emftext.language.sql.resource.sql.ui.SqlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.sql.resource.sql.ui.SqlSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.emftext.language.sql.resource.sql.ui.SqlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.sql.resource.sql.ui.SqlSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.emftext.language.sql.resource.sql.ui.SqlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.sql.resource.sql.ui.SqlSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.emftext.language.sql.resource.sql.ui.SqlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.sql.resource.sql.ui.SqlSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.emftext.language.sql.resource.sql.ui.SqlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.sql.resource.sql.ui.SqlSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(Composite composite, int horizontalSpan) {
		org.emftext.language.sql.resource.sql.ui.SqlPixelConverter pixelConverter = new org.emftext.language.sql.resource.sql.ui.SqlPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.emftext.language.sql.resource.sql.ui.SqlEditor) {
			org.emftext.language.sql.resource.sql.ui.SqlEditor emfTextEditor = (org.emftext.language.sql.resource.sql.ui.SqlEditor) editor;
