...
public class SqlPropertySheetPage extends PropertySheetPage implements ISelectionChangedListener {
	...
	public void selectionChanged(IWorkbenchPart part, ISelection iSelection) {
		...
		if (iSelection instanceof org.emftext.language.sql.resource.sql.ui.SqlEObjectSelection) {
			final org.emftext.language.sql.resource.sql.ui.SqlEObjectSelection selection = (org.emftext.language.sql.resource.sql.ui.SqlEObjectSelection) iSelection;
