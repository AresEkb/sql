 ...
 */
public class SqlExpectedTerminal {
	...
	private org.emftext.language.sql.resource.sql.ISqlExpectedElement terminal;
	private int startIncludingHiddenTokens;
	private int startExcludingHiddenTokens;
	private String prefix;
	private org.emftext.language.sql.resource.sql.grammar.SqlContainmentTrace containmentTrace;
	
	public SqlExpectedTerminal(EObject container, org.emftext.language.sql.resource.sql.ISqlExpectedElement terminal, int followSetID, org.emftext.language.sql.resource.sql.grammar.SqlContainmentTrace containmentTrace) {
		super();
	...
	public org.emftext.language.sql.resource.sql.ISqlExpectedElement getTerminal() {
		return terminal;
	}
	...
	public boolean equals(Object o) {
		...
		SqlExpectedTerminal otherExpectedTerminal = (SqlExpectedTerminal) o;
	...
	public org.emftext.language.sql.resource.sql.grammar.SqlContainmentTrace getContainmentTrace() {
