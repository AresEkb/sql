...
public class SqlBuilder implements org.emftext.language.sql.resource.sql.ISqlBuilder {
	...
	public IStatus build(org.emftext.language.sql.resource.sql.mopp.SqlResource resource, IProgressMonitor monitor) {
