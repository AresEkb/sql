...
public class SqlTokenStyle implements org.emftext.language.sql.resource.sql.ISqlTokenStyle {
	...
	public SqlTokenStyle(int[] colorAsRGB, int[] backgroundColorAsRGB, boolean bold, boolean italic, boolean striketrough, boolean underline) {
		super();
	...
	public SqlTokenStyle(org.emftext.language.sql.resource.sql.ISqlTokenStyle styleToCopy) {
	...
	public boolean equals(Object obj) {
		...
		org.emftext.language.sql.resource.sql.mopp.SqlTokenStyle other = (org.emftext.language.sql.resource.sql.mopp.SqlTokenStyle) obj;
