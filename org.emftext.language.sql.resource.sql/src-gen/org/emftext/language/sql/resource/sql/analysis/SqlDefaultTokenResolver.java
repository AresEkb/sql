 ...
 * </p>
 */
public class SqlDefaultTokenResolver implements org.emftext.language.sql.resource.sql.ISqlTokenResolver {
	 ...
	 */
	public SqlDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public SqlDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, EStructuralFeature feature, org.emftext.language.sql.resource.sql.ISqlTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.emftext.language.sql.resource.sql.grammar.SqlGrammarInformationProvider.INSTANCE.getKeywords()) {
