 ...
 * conversion.
 */
public interface ISqlInputStreamProcessorProvider {
	 ...
	 */
	public org.emftext.language.sql.resource.sql.mopp.SqlInputStreamProcessor getInputStreamProcessor(InputStream inputStream);
}
