 ...
 */
public class SqlBracketPair implements org.emftext.language.sql.resource.sql.ISqlBracketPair {
	...
	public SqlBracketPair(String openingBracket, String closingBracket, boolean closingEnabledInside, boolean closeAfterEnter) {
		super();
		this.openingBracket = openingBracket;
		this.closingBracket = closingBracket;
		this.closingEnabledInside = closingEnabledInside;
