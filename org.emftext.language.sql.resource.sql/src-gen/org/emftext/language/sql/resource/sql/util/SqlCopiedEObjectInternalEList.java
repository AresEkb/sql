...
public class SqlCopiedEObjectInternalEList extends org.emftext.language.sql.resource.sql.util.SqlCopiedEList<EObject> implements InternalEList<EObject> {
	
	private InternalEList<EObject> original;
	private InternalEList<EObject> copy;
	
	public SqlCopiedEObjectInternalEList(InternalEList<EObject> original) {
		super(original);
