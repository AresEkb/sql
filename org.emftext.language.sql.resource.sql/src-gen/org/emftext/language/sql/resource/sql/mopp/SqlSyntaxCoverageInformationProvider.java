...
public class SqlSyntaxCoverageInformationProvider {
	...
	public EClass[] getClassesWithSyntax() {
		return new EClass[] {
			...
			org.emftext.language.sql.literal.LiteralPackage.eINSTANCE.getIntervalLiteral(),
			...
			org.emftext.language.sql.datatype.DatatypePackage.eINSTANCE.getDatetimeType(),
