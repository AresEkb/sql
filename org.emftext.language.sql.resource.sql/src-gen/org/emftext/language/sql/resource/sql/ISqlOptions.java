...
public interface ISqlOptions {
	 ...
	 */
	public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new org.emftext.language.sql.resource.sql.mopp.SqlMetaInformation().getInputStreamPreprocessorProviderOptionKey();
	
	/**
	 * The key for the option to provide a resource post-processor.
	 */
	public String RESOURCE_POSTPROCESSOR_PROVIDER = new org.emftext.language.sql.resource.sql.mopp.SqlMetaInformation().getResourcePostProcessorProviderOptionKey();
