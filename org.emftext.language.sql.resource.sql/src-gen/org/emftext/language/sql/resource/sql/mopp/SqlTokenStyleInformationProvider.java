...
public class SqlTokenStyleInformationProvider {
	...
	public org.emftext.language.sql.resource.sql.ISqlTokenStyle getDefaultTokenStyle(String tokenName) {
		if ("KEYWORD_CHARACTER".equals(tokenName)) {
			return new org.emftext.language.sql.resource.sql.mopp.SqlTokenStyle(new int[] {0x25, 0x18, 0xB5}, null, true, false, false, false);
		}
		...
		if ("DOUBLE_PRECISION".equals(tokenName)) {
			return new org.emftext.language.sql.resource.sql.mopp.SqlTokenStyle(new int[] {0x25, 0x18, 0xB5}, null, true, false, false, false);
		}
		...
		if ("KEYWORD_ON".equals(tokenName)) {
			return new org.emftext.language.sql.resource.sql.mopp.SqlTokenStyle(new int[] {0x80, 0x00, 0x55}, null, true, false, false, false);
		}
		if ("KEYWORD_COMMIT".equals(tokenName)) {
			return new org.emftext.language.sql.resource.sql.mopp.SqlTokenStyle(new int[] {0x80, 0x00, 0x55}, null, true, false, false, false);
		}
		if ("PRESERVE".equals(tokenName)) {
			return new org.emftext.language.sql.resource.sql.mopp.SqlTokenStyle(new int[] {0x80, 0x00, 0x55}, null, true, false, false, false);
		}
		if ("DELETE".equals(tokenName)) {
			return new org.emftext.language.sql.resource.sql.mopp.SqlTokenStyle(new int[] {0x80, 0x00, 0x55}, null, true, false, false, false);
		}
		if ("KEYWORD_ROWS".equals(tokenName)) {
			return new org.emftext.language.sql.resource.sql.mopp.SqlTokenStyle(new int[] {0x80, 0x00, 0x55}, null, true, false, false, false);
		}
		...
		if ("KEYWORD_INTERVAL".equals(tokenName)) {
			return new org.emftext.language.sql.resource.sql.mopp.SqlTokenStyle(new int[] {0x80, 0x00, 0x55}, null, true, false, false, false);
		}
		...
		if ("WITH TIME ZONE".equals(tokenName)) {
			return new org.emftext.language.sql.resource.sql.mopp.SqlTokenStyle(new int[] {0x80, 0x00, 0x55}, null, true, false, false, false);
		}
		if ("WITHOUT TIME ZONE".equals(tokenName)) {
			return new org.emftext.language.sql.resource.sql.mopp.SqlTokenStyle(new int[] {0x80, 0x00, 0x55}, null, true, false, false, false);
		}
