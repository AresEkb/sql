...
public class SqlNature implements IProjectNature {
	
	public static final String NATURE_ID = "org.emftext.language.sql.resource.sql.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {org.emftext.language.sql.resource.sql.mopp.SqlBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.emftext.language.sql.resource.sql.mopp.SqlBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
