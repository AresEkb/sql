...
public abstract class SqlQuickFix implements org.emftext.language.sql.resource.sql.ISqlQuickFix {
	...
	public SqlQuickFix(String displayString, String imageKey, EObject contextObject) {
		this(displayString, imageKey, Collections.singleton(contextObject), contextObject.eResource());
	}
	
	public SqlQuickFix(String displayString, String imageKey, Collection<EObject> contextObjects) {
		this(displayString, imageKey, contextObjects, contextObjects.iterator().next().eResource());
	}
	
	public SqlQuickFix(String displayString, String imageKey, Collection<EObject> contextObjects, Resource resource) {
		super();
	...
	public String apply(String currentText) {
		...
		try {
			...
			new org.emftext.language.sql.resource.sql.util.SqlRuntimeUtil().logError("Exception while applying quick fix", e);
		}
		return null;
	}
