...
public class SqlResourceBundle {
	 ...
	 * are running.
	 */
	public static String BUILDER_ADAPTER_TASK_NAME = "Building sql file";
	...
	static {
		try {
			ResourceBundle bundle = ResourceBundle.getBundle(SqlResourceBundle.class.getName(), Locale.getDefault());
			if (bundle != null) {
				Set<String> keys = bundle.keySet();
				for (String key : keys) {
					String value = bundle.getString(key);
					try {
						Field field = SqlResourceBundle.class.getDeclaredField(key.toUpperCase());
