 ...
 */
public class SqlEnumerationTerminal extends org.emftext.language.sql.resource.sql.grammar.SqlTerminal {
	
	private Map<String, String> mapping = new LinkedHashMap<String, String>();
	
	public SqlEnumerationTerminal(EStructuralFeature attribute, String[] literalMappings, org.emftext.language.sql.resource.sql.grammar.SqlCardinality cardinality, int mandatoryOccurrencesAfter) {
