...
/**
 * <p>
 * A SqlLayoutInformationAdapter is used to store layout information that is found
 ...
 * SqlLayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 * </p>
 */
public class SqlLayoutInformationAdapter implements Adapter {
	 ...
	 * reference.
	 */
	private List<org.emftext.language.sql.resource.sql.mopp.SqlLayoutInformation> layoutInformations = new ArrayList<org.emftext.language.sql.resource.sql.mopp.SqlLayoutInformation>();
	...
	public List<org.emftext.language.sql.resource.sql.mopp.SqlLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(org.emftext.language.sql.resource.sql.mopp.SqlLayoutInformation layoutInformation) {
