...
public class SqlTokenResolverFactory implements org.emftext.language.sql.resource.sql.ISqlTokenResolverFactory {
	...
	public SqlTokenResolverFactory() {
		...
		registerTokenResolver("SCHEMA_QUALIFIED_NAME", new org.emftext.language.sql.resource.sql.analysis.SqlSCHEMA_QUALIFIED_NAMETokenResolver());
		registerTokenResolver("TEXT", new org.emftext.language.sql.resource.sql.analysis.SqlTEXTTokenResolver());
	}
