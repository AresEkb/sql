 ...
 * to 4 bytes).
 */
public class SqlUnicodeConverter extends org.emftext.language.sql.resource.sql.mopp.SqlInputStreamProcessor {
	 ...
	 */
	public SqlUnicodeConverter(InputStream inputStream) {
